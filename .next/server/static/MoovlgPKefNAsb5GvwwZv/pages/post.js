...
/* harmony import */ var isomorphic_fetch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
...
var nanoid = __webpack_require__(10);
...
var MyLayout_Layout = function Layout(_ref) {
  ...
  return external_react_default.a.createElement(BaseStyles, null, external_react_default.a.createElement(LayoutInner, null, external_react_default.a.createElement(components_Sidebar, {
    data: sidebar
  }), external_react_default.a.createElement(Content, null, children)));
};
...
var rich_text_html_renderer_ = __webpack_require__(13);

// EXTERNAL MODULE: external "@contentful/rich-text-types"
var rich_text_types_ = __webpack_require__(14);
...
var external_html_react_parser_ = __webpack_require__(15);
...
var external_nanoid_ = __webpack_require__(10);

// EXTERNAL MODULE: ./util/dataFetching.js
var dataFetching = __webpack_require__(5);

// EXTERNAL MODULE: ./components/MyLayout.js + 5 modules
var MyLayout = __webpack_require__(8);
...
var external_clean_tag_ = __webpack_require__(16);
...
/* harmony default export */ var atoms_Box = (atoms_Box_Box);
...
var StyledTitle = external_styled_components_default()(atoms_Box).withConfig({
...
/* harmony default export */ var atoms_Title = (atoms_Title_Title);
// CONCATENATED MODULE: ./components/atoms/Text/Text.js




var StyledText = external_styled_components_default()(atoms_Box).withConfig({
...
var post_StyledTitle = external_styled_components_default()(atoms_Title).withConfig({
...
var post_Content = function Content(_ref2) {
  ...
  return external_react_default.a.createElement("div", null, external_react_default.a.createElement(atoms_Title, {
    is: "h2",
    size: "h2"
  }, title), external_react_default.a.createElement(atoms_Box, null, parsed));
};
...
var post_Page = function Page(_ref3) {
  var sidebar = _ref3.sidebar,
      ...
      title = _ref3.title,
      slug = _ref3.slug;
  return external_react_default.a.createElement(MyLayout["a" /* default */], {
    sidebar: sidebar

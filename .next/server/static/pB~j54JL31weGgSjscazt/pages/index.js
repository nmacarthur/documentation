...
// CONCATENATED MODULE: ./components/IndexLayout.js
...
var Content = external_styled_components_default.a.main.withConfig({
...
var IndexLayout_IndexLayout = function IndexLayout(_ref) {
  var sidebar = _ref.sidebar,
      children = _ref.children;
  return external_react_default.a.createElement(BaseStyles, null, external_react_default.a.createElement(LayoutInner, null, external_react_default.a.createElement(Content, null, children)));
};

/* harmony default export */ var components_IndexLayout = (IndexLayout_IndexLayout);
// EXTERNAL MODULE: external "prop-types"
var external_prop_types_ = __webpack_require__(9);
...
// CONCATENATED MODULE: ./components/atoms/Button/Button.js
...
var Button_btnBg = function btnBg(_ref4) {
  var color = _ref4.color,
      skin = _ref4.skin;
  return Object(external_styled_system_["themeGet"])(skin === 'outline' ? "colors.white" : "colors.".concat(color));
};

var Button_btnColor = function btnColor(_ref5) {
  var color = _ref5.color,
      skin = _ref5.skin;
  return Object(external_styled_system_["themeGet"])(skin === 'fill' ? "colors.white" : "colors.".concat(color));
};
...
var styles = Object(external_styled_components_["css"])(["display:inline-block;vertical-align:middle;text-align:center;text-decoration:none;touch-action:manipulation;outline:none;user-select:none;transition:0.1s ease;padding:", ";border-radius:0;width:", ";cursor:", ";opacity:", ";color:", ";background:", ";border:1px solid ", ";font-size:", "px;line-height:", ";font-weight:", ";", ";", ";", ";"], padding, width, cursor, opacity, Button_btnColor, Button_btnBg, function (_ref6) {
  var color = _ref6.color;
  return Object(external_styled_system_["themeGet"])("colors.".concat(color));
}, function (props) {
  return Object(external_styled_system_["themeGet"])(fontSize(props));
}, function (props) {
  return Object(external_styled_system_["themeGet"])(lineHeight(props));
}, function (_ref7) {
  var kind = _ref7.kind;
  return kind === 'target' ? 'bold' : null;
}, function (_ref8) {
  var disabled = _ref8.disabled;
  return !disabled ? Object(external_styled_components_["css"])(["&:hover{border-color:", ";background:", ";color:", ";}"], Object(external_styled_system_["themeGet"])('colors.black'), function (_ref9) {
    var color = _ref9.color,
        skin = _ref9.skin;
    return Object(external_styled_system_["themeGet"])(color === 'black' && skin === 'fill' ? 'colors.white' : 'colors.black');
  }, function (_ref10) {
    var color = _ref10.color,
        skin = _ref10.skin;
    return Object(external_styled_system_["themeGet"])(color === 'black' && skin === 'fill' ? 'colors.black' : 'colors.white');
  }) : null;
}, external_styled_system_["space"], external_styled_system_["maxWidth"]);
var StyledNavLink = external_styled_components_default()(external_react_router_dom_["NavLink"]).withConfig({
  displayName: "Button__StyledNavLink",
  componentId: "sc-1f1rx45-0"
})(["", ";"], styles);
var StyledLink = external_styled_components_default()(external_clean_tag_default.a.a).withConfig({
  displayName: "Button__StyledLink",
  componentId: "sc-1f1rx45-1"
})(["", ";"], styles);
var StyledButton = external_styled_components_default()(external_clean_tag_default.a.button).withConfig({
  displayName: "Button__StyledButton",
  componentId: "sc-1f1rx45-2"
})(["", ";"], styles);

var Button_Button = function Button(_ref11) {
  var to = _ref11.to,
      href = _ref11.href,
      type = _ref11.type,
      wide = _ref11.wide,
  ...
  if (to) {
    return external_react_default.a.createElement(StyledNavLink, _extends({
      to: to,
      wide: wide ? 1 : 0
    }, rest));
  }
  ...
  if (href) {
    return external_react_default.a.createElement(StyledLink, _extends({
      href: href,
      wide: wide ? 1 : 0
    }, rest));
  }
...
/* harmony default export */ var atoms_Button_Button = (Button_Button);
// CONCATENATED MODULE: ./components/atoms/Button/index.js

/* harmony default export */ var atoms_Button = (atoms_Button_Button);
// EXTERNAL MODULE: ./components/atoms/Box/index.js + 1 modules
var Box = __webpack_require__(4);
...
// CONCATENATED MODULE: ./components/atoms/Container/Container.js





var StyledContainer = external_styled_components_default()(Box["a" /* default */]).withConfig({
  displayName: "Container__StyledContainer",
  componentId: "iuics-0"
})(["position:relative;box-sizing:content-box;"]);

var Container_Container = function Container(props) {
  return external_react_default.a.createElement(StyledContainer, props);
};

Container_Container.defaultProps = {
  px: [theme["space"].s, theme["space"].m],
  mx: 'auto',
  maxWidth: theme["breakpoints"][2]
};
/* harmony default export */ var atoms_Container_Container = (Container_Container);
// CONCATENATED MODULE: ./components/atoms/Container/index.js

/* harmony default export */ var atoms_Container = (atoms_Container_Container);
...
var pages_Index = function Index(_ref) {
  var data = _ref.data;
  return external_react_default.a.createElement(components_IndexLayout, null, external_react_default.a.createElement(atoms_Container, null, external_react_default.a.createElement(Title["a" /* default */], {
    type: "h1",
    size: "h1"
  }, "New Word Order Writing Guide"), external_react_default.a.createElement(atoms_Button, {
    href: "./introduction",
    skin: "outline"
  }, "Go.")));
};
